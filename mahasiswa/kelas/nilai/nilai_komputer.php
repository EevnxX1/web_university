...
$data_nilai = query("SELECT * FROM tb_nilai WHERE matkul_nilai = 'Arsitektur Dan Organisasi Komputer' ORDER BY prtmn_nilai ASC");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
    ...
    <div class="container">
      <h2 class="h2">Nilai Arsitektur Dan Organisasi Komputer</h2>
